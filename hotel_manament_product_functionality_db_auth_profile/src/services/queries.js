...
// we use promise.all to resolve all promise together, we do not want to resolve many and rest of promises become not resolve. if one is not becoming resolve, then all will not resolve.
