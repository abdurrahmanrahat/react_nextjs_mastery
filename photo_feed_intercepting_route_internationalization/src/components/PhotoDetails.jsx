...
import FollowImage from "@/asserts/icons/follow.svg";
import HeartImage from "@/asserts/icons/heart.svg";
import SaveImage from "@/asserts/icons/save.svg";
import ShareImage from "@/asserts/icons/share.svg";
        ...
        <div className="mt-6">
          <div className="flex justify-between items-center mb-3">
            ...
            <button className="flex items-center gap-1.5 text-black/60 text-xs xl:text-sm">
              <Image src={FollowImage} className="w-5 h-5" alt="follow" />
              {dictionary.follow}
            </button>
          </div>
